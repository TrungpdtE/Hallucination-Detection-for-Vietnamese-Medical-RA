...
1. **RAG module**: tìm tài liệu liên quan và sinh câu trả lời.
2. **Hallucination Detection module**: kiểm tra câu trả lời sau khi sinh bằng PhoBERT fine-tuned.
...
flowchart TD
    ...
    Dense[Dense retriever / vector search]
...
flowchart TD
    User[User question]
    Retriever[Hybrid Retriever<br/>BM25 + Dense Search]
